...
export const FilterMenu = ({ filterResult, setFilterResult, alternative, allProducts, filterMenuActive, setFilterMenuActive, catName, sub }) => {
    ...
    const [categoryLabels, setCategoryLabels] = useState(['تيشيرت', 'أحذية', 'شورت', 'هودي']);
    ...
    const searchByFilter = () => {
        ...
        if (catName == 'al-ahly') {
            srchResult = [...allProducts, ...alternative].filter(prd => prd.arcategory.replace(' ', '') == 'الأهلى');
    ...
    useEffect(() => {
        document.body.style.cssText = filterMenuActive ? 'height:100vh;overflow:hidden;' : 'height:100%;overflow:auto;'
    }, [filterMenuActive])
        ...
        <>
            ...
            <div className="shadow-container-filter">
                <div className="filter-menu" dir='rtl'>
                    ...
                    <button className='btn-adidas-dark w-100 my-5' onClick={() => searchByFilter()}>
