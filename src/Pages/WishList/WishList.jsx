...
export default function WishList() {
  ...
  useEffect(() => {
    ...
    // const test1 = localStorage.setItem('email', "eslam11@gmail.com");
  ...
  const handleRemove = (prdId) => {
    dispatch(removeFromWishList(prdId));
    setShowAlert(true);
  };
